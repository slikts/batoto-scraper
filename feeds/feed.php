...
$profile_title = $profile['title'] ? $profile['title'] : $profile_id;
$feed_title = htmlspecialchars("Batoto scraper profile {$profile_title}");
$items = $data->get_items($profile, $item_limit);
?>
    ...
    <channel>
        ...
        <?php foreach ($items as $item) : ?>
            ...
            <item>
                ...
                <description>
                    <![CDATA[<?php echo htmlspecialchars($item['title']); ?>]]>
                </description>
            </item>
        <?php endforeach; ?>
    </channel>
